Privacy policy  
This Service is provided by Amana Games at no cost and is intended for use as is.  
...
* [https://gameanalytics.com/privacy](https://gameanalytics.com/privacy)  
...
When you install and use Amana Games mobile applications, we can collect and process some of your data for different legitimate purposes.  
You will find below explanations regarding the reasons why we may collect data.

## Why is data collected?

Amana Games and its third-party partners collect data:
...
The third-party partners that Amana Games will share the data with are:
...
To delete user data collected by Amana Games please reach out to Anastasia.mel.2.2.2@gmail.com  
